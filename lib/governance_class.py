...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to idapayd "gobject list" output
    ...
    def idapayd_serialise(self):
        import idapaylib
        return idapaylib.SHIM_serialise_for_idapayd(self.serialise())
